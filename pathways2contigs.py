...
write a table that lists pathway - coverage - KEGG ID - contig name which contains that KEGG ID. Also requires ontology file. for example: /srv/databases/ontology/foam
